...
- `evidenceSummary` is a lossless compact ledger of those supported facts. Keep distinct items, sessions, and updates separate; add no unsupported conclusion or final benchmark answer.
