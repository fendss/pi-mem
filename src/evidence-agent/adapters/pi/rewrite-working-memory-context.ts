...
Only the question, current note and unacknowledged tool results are retained.
A valid replacement after a successful action acknowledges the results you have
already seen. Omission, null, a rejected note or a failed action preserves them.
      ...
      return tools.map(tool => {
        ...
        return {
          ...
          async execute(id, params, signal, onUpdate) {
            ...
            const acknowledgedToolCallIds = unchanged || rejection ? [] : seen;
