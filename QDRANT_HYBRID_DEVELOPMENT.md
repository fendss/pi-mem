...
| 2 | Add an internal Qdrant Server deployment, collection bootstrap, and strict scope/profile filtering | Health, persistence, idempotent upsert, and isolation integration tests pass | In progress |
| 3 | Add a transactional SQLite outbox, asynchronous batched synchronization, generation finalization, and a READY barrier | Crash resume and incomplete-generation rejection tests pass | Pending |
