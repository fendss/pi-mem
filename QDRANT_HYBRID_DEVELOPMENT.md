...
| 5 | Move synchronous SQLite retrieval/read/operator work off the Agent event loop into read-only workers | Event-loop and scope-isolation concurrency tests pass | In progress |
