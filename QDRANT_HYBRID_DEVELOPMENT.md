...
| 6 | Exercise failure, cancellation, stale-index, idempotency, provenance, and cross-scope cases | No partial-index search, scope leak, or provenance violation | In progress |
